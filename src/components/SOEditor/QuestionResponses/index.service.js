...
export const withQuestionResponseRedux = (
  ...
  const mapDispatchToProps = (dispatch) => ({
    ...
    ACTION_SCOPED_OBJECT_DELETE_REQUESTED: (scopedObjectId: number) => {
      dispatch(
        questionResponseActions.ACTION_SCOPED_OBJECT_DELETE_REQUESTED(
          scopedObjectId,
        ),
      );
    },
    ACTION_SCOPED_OBJECT_CREATE_REQUESTED: (
      ...
      dispatch(
        questionResponseActions.ACTION_RESPONSE_CREATE_REQUESTED(
          scopedObjectData,
        ),
      );
    },
    ACTION_SCOPED_OBJECT_UPDATE_REQUESTED: (
      ...
      dispatch(
        questionResponseActions.ACTION_RESPONSE_UPDATE_REQUESTED(
          scopedObjectData,
        ),
      );
    },
